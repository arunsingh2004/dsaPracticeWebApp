    ...
    return (
      <Fade duration={500 + 1 * 50} key={-1}>
        <div>
          <Link
            to={{
              pathname: "https://practice.geeksforgeeks.org/problem-of-the-day",
            }}
            target="_blank"
            style={{ textDecoration: "none" }}
          >
              ...
              <Card.Body style={{ padding: "12px" }}>
                ...
                >
                  <h4 className="promotional-heading">
                    Develop the habit of coding and become a better & consistent
                    coder by solving 1 problem based on Data Structures and
                    Algorithms every day and stand a chance to win exciting
                    prizes too(GFG(POTD))
                  </h4>
  ...
  return (
    <>
      ...
      <div className="container container-custom">
        {promotionTile()}
        <div className="row row-cols-1 overflow-scroll row-cols-md-3 mt-3 grids">
          {topicCard}
        </div>
      </div>
    </>
