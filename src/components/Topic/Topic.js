...
export default function Topic({ data, updateData }) {
  ...
  */
  ...
  const [isBookmarkSortFilterSelected, setIsBookmarkSortFilterSelected] =
    useState(false);
          ...
          links: (
            ...
            >
              {question.URL2.length > 0 && (
                ...
                // onClick={() => {
                //   window.open(
                //     `${question.URL2}&utm_source=website&utm_medium=affiliate&utm_campaign=450dsatracker`,
                //     "_blank"
                //   );
                // }}
                />
          ...
          controls: (
            ...
            >
              ...
              <OverlayTrigger
                ...
                overlay={
                  !question.Bookmark
                    ? renderTooltipAddBookmark
                    : renderTooltipRemoveBookmark
                }
              >
                <svg
        ...
        <div className="container">
          <InputGroup className="mb-4">
            ...
            <OverlayTrigger
              placement="left"
              overlay={
                isBookmarkSortFilterSelected
                  ? renderTooltipResetSortBookmark
                  : renderTooltipSortBookmark
              }
            >
              <Button
                variant={
                  isBookmarkSortFilterSelected ? "success" : "outline-success"
                }
